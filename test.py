...
cet_scenario = CET_Scenario(acc_version=2018, first_year=2018, market_effects=0.05, match_sql=False)
...
comparison = sql_cet_output[['CET_ID','ElecBen','GasBen','TRCCost','TRCRatio']].merge(py_cet_output[['CET_ID','ElecBenNet','GasBenNet','TotalResourceCostNet','TotalResourceCostRatio']],how='left',on='CET_ID')
